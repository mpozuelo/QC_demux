...
def add_bed_file(FileIn,FileOut):
    ...
    cov['fastq1'] = "/datos/ngs/dato-activo/data/04_pfastq/" + cov['platform'] + '/' + cov['run'] + '/' + cov['lane'] + '/' + cov['user'] + '/demux_fastq/' + str(cov['sampleID']) + '_' + cov['run'] + '_' + cov['lane'] + '_R1.fq.gz'
    cov['fastq2'] = "/datos/ngs/dato-activo/data/04_pfastq/" + cov['platform'] + '/' + cov['run'] + '/' + cov['lane'] + '/' + cov['user'] + '/demux_fastq/' + str(cov['sampleID']) + '_' + cov['run'] + '_' + cov['lane'] + '_R2.fq.gz'
